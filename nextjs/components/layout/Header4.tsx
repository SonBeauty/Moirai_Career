...
const Header4: React.FC<HeaderProps> = ({ handleOpen, headerStyle }) => {
    ...
    return (
        <>
            <header className={scroll ? `${headerStyle} header header-4 bg-gray-1000 sticky-bar stick ` : `${headerStyle} header header-4 bg-gray-1000 sticky-bar`}>
                    ...
                    <div className="main-header">
                        <div className="header-left">
                            <div className="header-logo">
                                <Link href="/">
                                    <a className="d-flex">
                                        {headerStyle ? <Image width={187} height={50} alt="Agon" src="/assets/imgs/template/logo-white.svg" /> : <Image width={187} height={50} alt="Agon" src="/assets/imgs/template/logo-white.svg" />}
                                    </a>
                                </Link>
                            </div>
                        ...
                        <div className="header-right">
                            <div className="block-signin">
                                <Link href="/page-signup"><a className="btn btn-gray hover-up icon-arrow-right-white">Get Started</a></Link>
                            </div>
                        </div>
                    </div>
                </div>
