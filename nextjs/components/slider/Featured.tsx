                                                ...
                                                <div className="product-info"><span className="text-body-small color-gray-500 font-bold">{item.brand}</span>
                                                    ...
                                                    <div className="rating mt-10">
                                                        <div className="box-rating">
                                                            <span></span><Image width={12} height={12} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" />
                                                            <span></span><Image width={12} height={12} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" />
                                                            <span></span><Image width={12} height={12} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" />
                                                            <span></span><Image width={12} height={12} src="/assets/imgs/page/homepage5/star-active.svg" alt="agon" />
                                                            <span></span><Image width={12} height={12} src="/assets/imgs/page/homepage5/star.svg" alt="agon" />
                                                        </div>
