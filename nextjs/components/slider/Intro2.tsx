                        ...
                        <div className="row">
                            <div className="col-12 swiper-slide-1">
                                <div className="grid-category grid-category-style-2">
                                    ...
                                    <div className="grid-image-bottom">
                                        <Link href="#"><a><Image width={274} height={154} src="/assets/imgs/page/homepage6/img-2.png" alt="image"/></a></Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 swiper-slide-1">
                                <div className="grid-category grid-category-style-2">
                                    ...
                                    <div className="grid-image-bottom">
                                        <Link href="#"><a><Image width={274} height={154} src="/assets/imgs/page/homepage6/img-3.png" alt="image"/></a></Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 swiper-slide-2">
                                <div className="grid-category grid-category-style-2">
                                    ...
                                    <div className="grid-image-bottom">
                                        <Link href="#"><a><Image width={174} height={230} src="/assets/imgs/page/homepage6/img-4.png" alt="image"/></a></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
