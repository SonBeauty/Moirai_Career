                            ...
                            <div className="row">
                                    ...
                                    <div className="row mt-50">
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div className="list-icons">
                                                <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/about/2/icon-project-done.svg" alt="Agon" /></span>
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div className="list-icons">
                                                <div className="list-icons">
                                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/about/2/icon-officer.svg" alt="Agon" /></span>
                                ...
                                <div className="col-lg-5 d-none d-lg-block">
                                    <div className="banner-imgs">
                                        <div className="block-1 shape-2"><Image width={310} height={96} src="/assets/imgs/page/services/1/banner-2.png" alt="Agon" /></div>
                                        <Image width={526} height={361} className="rounded-4" src="/assets/imgs/page/services/1/banner.png" alt="Agon" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container mt-20">
                        <div className="row">
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-support.svg" alt="Agon" /></span>
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-web.svg" alt="Agon" /></span>
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-business.svg" alt="Agon" /></span>
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-product.svg" alt="Agon" /></span>
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-share.svg" alt="Agon" /></span>
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-build.svg" alt="Agon" /></span>
                                        <h4 className="text-heading-6">Support Engineer</h4>
                                        <p className="text-body-text color-gray-500 mt-15">We commit to original work of the highest standard and giving credit where it&apos;s due.</p>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-team.svg" alt="Agon" /></span>
                                        <h4 className="text-heading-6">Support Engineer</h4>
                                        <p className="text-body-text color-gray-500 mt-15">We commit to original work of the highest standard and giving credit where it&apos;s due.</p>
                                    </div>
                                </div>
                    ...
                    <div className="container mt-70">
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-sm-12 block-we-do">
                                <div className="inner-image"><Image width={608} height={710} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage2/img-built.png" alt="Agon" />
                                    <div className="block-image-bottom"><Image width={313} height={330} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage2/img-built-2.png" alt="Agon" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
