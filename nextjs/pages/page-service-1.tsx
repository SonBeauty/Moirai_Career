                            ...
                            <div className="row">
                                    ...
                                    <div className="row mt-50">
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div className="list-icons">
                                                <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/services/1/icon-scissors.svg" alt="Moirai" /></span>
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div className="list-icons">
                                                <div className="list-icons">
                                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/services/1/icon-heart.svg" alt="Moirai" /></span>
                                ...
                                <div className="col-lg-6 d-none d-lg-block">
                                    <div className="banner-imgs relative h-full">
                                        <div className="block-services-1"><Image width={850} height={515} src="/assets/imgs/page/services/1/banner.png" alt="Moirai" /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container mt-20">
                        <div className="row">
                            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-checking.svg" alt="Moirai" /></span>
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-comfirm.svg" alt="Moirai" /></span>
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-sewing.svg" alt="Moirai" /></span>
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-check-all.svg" alt="Moirai" /></span>
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-iron.svg" alt="Moirai" /></span>
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div className="list-icons">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={52} height={52} src="/assets/imgs/page/services/1/icon-delivery.svg" alt="Moirai" /></span>
                    ...
                    <div className="container mt-70">
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-sm-12 block-we-do">
                                <div className="inner-image block-image-main bdrd-16"><Image width={576} height={655} src="/assets/imgs/page/services/1/img-built-1.png" alt="Moirai" />
                                    <div className="block-image-top bdrd-16 flex"><Image width={313} height={329} src="/assets/imgs/page/services/1/img-built-2.png" alt="Moirai" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-7 col-md-5 mt-30 mt-lg-0 mt-md-30 mt-sm-30 position-relative text-end">
                                            <div className="block-chart shape-1">
                                                <Image width={255} height={193} src="/assets/imgs/template/chart-4.png" alt="Moirai" />
                                            </div>
