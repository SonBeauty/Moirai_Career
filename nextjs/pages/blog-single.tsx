...
function BlogSingle(): JSX.Element {
    return (
        <>
            <Layout>
                <div>
                    ...
                    <section className="section-box mt-50 mb-50">
                        <div className="container">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-md-7 col-sm-7 col-7">
                                            <div className="blog-img-user">
                                                <div className="img-user img-user-round"><Image width={56} height={56} src="/assets/imgs/page/blog/2/user-3.png" alt="Agon" /></div>
                            ...
                            <div className="row">
                                <div className="col-lg-2" />
                                <div className="col-lg-8">
                                    <div className="single-detail mt-50"><Image width={856} height={413} className="img-responsive bdr-16" src="/assets/imgs/page/blog/single/img-1.png" alt="Agon" />
                                        <p />
                                        ...
                                        <div className="box-quote">
                                            ...
                                            <div className="box-user">
                                                <div className="img-user"><Image width={56} height={56} src="/assets/imgs/page/blog/single/user-4.png" alt="Agon" /></div><span className="text-heading-5 color-white">Ronald Richards</span>
                                            </div>
                                        </div>
                                        <p />
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-4"><Image width={269} height={353} className="img-responsive bdr-10 mt-10" src="/assets/imgs/page/blog/single/img-2.png" alt="Agon" /></div>
                                        </div>
                                        <p />
                                        ...
                                        <div className="row mt-45 mb-30">
                                            <div className="col-lg-6"><Image width={416} height={468} className="img-responsive" src="/assets/imgs/page/blog/single/img-3.png" alt="Agon" /></div>
                                            <div className="col-lg-6">
                                                <Image width={416} height={221} className="img-responsive mb-20" src="/assets/imgs/page/blog/single/img-4.png" alt="Agon" />
                                                <Image width={416} height={221} className="img-responsive" src="/assets/imgs/page/blog/single/img-5.png" alt="Agon" />
                                            </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div className="item-comment">
                                                        <div className="blog-img-user">
                                                            <div className="img-user img-user-round"><Image width={56} height={56} src="/assets/imgs/page/blog/single/user-1.png" alt="Agon" /></div>
                                                ...
                                                <li>
                                                    <div className="item-comment">
                                                        <div className="blog-img-user">
                                                            <div className="img-user img-user-round"><Image width={56} height={56} src="/assets/imgs/page/blog/single/user-2.png" alt="Agon" /></div>
                                                            <h4 className="text-heading-6 color-gray-900">Robert Fox</h4>
                                                            <p className="text-body-small color-gray-500">August 25, 2022</p>
                                                        </div>
                                                        <div className="text-comment">White white dreamy drama tically place everything although. Place out apartment afternoon whimsical kinder, little romantic joy we flowers handmade.</div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div className="item-comment">
                                                                <div className="blog-img-user">
                                                                    <div className="img-user img-user-round"><Image width={56} height={56} src="/assets/imgs/page/blog/single/user-3.png" alt="Agon" /></div>
                                                                    <h4 className="text-heading-6 color-gray-900">Robert Fox</h4>
                                                                    <p className="text-body-small color-gray-500">August 25, 2022</p>
                                                                </div>
                                                                <div className="text-comment">White white dreamy drama tically place everything although. Place out apartment afternoon whimsical kinder, little romantic joy we flowers handmade.</div>
