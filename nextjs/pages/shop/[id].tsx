                                            ...
                                            <div className="col-lg-12">
                                                ...
                                                <div className="tab-content mt-50">
                                                    ...
                                                    <div className={activeIndex === 3 ? "tab-pane fade active show" : "tab-pane fade"}>
                                                        <div className="vendor-logo d-flex mb-30"><Image width={64} height={43} src="/assets/imgs/page/single-product/vendor-18.svg" alt="image"/>
                                                        ...
                                                        <ul className="contact-infor mb-50">
                                                            <li><Image width={16} height={16} src="/assets/imgs/page/single-product/icon-location.svg" alt="image"/><strong>Address: </strong><span>5171 W Campbell Ave undefined Kent, Utah 53127 United States</span></li>
                                                            <li><Image width={16} height={16} src="/assets/imgs/page/single-product/icon-contact.svg" alt="image"/><strong>Contact Seller:</strong><span>(+91) - 540-025-553</span></li>
                                                        </ul>
                                                                    ...
                                                                    <div className="comment-list">
                                                                        <div className="single-comment justify-content-between d-flex mb-30">
                                                                            <div className="user justify-content-between d-flex">
                                                                                <div className="thumb text-center"><Image width={80} height={80} src="/assets/imgs/page/single-product/author-2.png" alt="image"/>
                                                                        ...
                                                                        <div className="single-comment justify-content-between d-flex mb-30 ml-30">
                                                                            <div className="user justify-content-between d-flex">
                                                                                <div className="thumb text-center"><Image width={80} height={80} src="/assets/imgs/page/single-product/author-3.png" alt="image"/>
                                                                        ...
                                                                        <div className="single-comment justify-content-between d-flex">
                                                                            <div className="user justify-content-between d-flex">
                                                                                <div className="thumb text-center"><Image width={80} height={80} src="/assets/imgs/page/single-product/author-4.png" alt="image"/>
