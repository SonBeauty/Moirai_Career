...
function ShopFrid1(): JSX.Element {
return (
    <>
        <Layout>
            ...
            <div className="container mt-70">
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    ...
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/pc.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/headphone.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/laptop.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/mobile.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/printer.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/book.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/tablet.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/usb.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/mouse.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/security.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/watch.svg" alt="agon" /></a></Link>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div className="category-grid-3 hover-up">
                    <div className="category-img">
                        <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/scan.svg" alt="agon" /></a></Link>
                    </div>
            ...
            <div className="container mt-70">
                ...
                {data.map((item, i) => (
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12" key={i}>
                        <div className="product-item-2 hover-up">
                        <Link href={`/shop/${item.id}`}>
                            <a>
                            <div className="product-image">
                            <Image width={215} height={215} className="img-fluid" src={`/assets/imgs/page/homepage5/${item.img}`} alt="" />
                            </div>
                        </a></Link>
            ...
            <div className="container mt-90">
                ...
                <div className="col-lg-4 col-sm-6 pr-30 mb-50">
                    ...
                    <div className="grid-4-img color-bg-9 mb-20">
                        <Link href="#"><a><Image width={398} height={465} src="/assets/imgs/page/shop1/img.png" alt="Agon" /></a></Link>
                    </div>
                ...
                <div className="col-lg-4 col-sm-6 pr-30 mb-50">
                    ...
                    <div className="grid-4-img color-bg-2 mb-20">
                        <Link href="#"><a><Image width={398} height={465} src="/assets/imgs/page/shop1/img-2.png" alt="Agon" /></a></Link>
                    </div>
                    <Link href="#"><a className="text-heading-4">We can blend colors multiple ways, the most common</a></Link>
                    <p className="text-body-text color-gray-500">Lorem ipsum dolor sit amet consectetur adipiscing elit interdum ullamcorper sed pharetra senectus donec nunc. Consequat semper viverra nam libero justo laoreet facilisis magna etiam.</p>
                    <div className="blog-img-user">
                ...
                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                    ...
                    <div className="style-1-img color-bg-10">
                        <Link href="#"><a><Image width={110} height={110} src="/assets/imgs/page/shop1/img-3.png" alt="Agon" /></a></Link>
                    </div>
                    </div>
                    <div className="card-list-style-1">
                    <Link href="#"><a className="text-heading-6">Design Studios That Everyone Should Know About?</a></Link>
                    ...
                    <div className="style-1-img color-bg-2">
                        <Link href="#"><a><Image width={110} height={110} src="/assets/imgs/page/shop1/img-4.png" alt="Agon" /></a></Link>
                    </div>
                    </div>
                    <div className="card-list-style-1">
                    <Link href="#"><a className="text-heading-6">Design Studios That Everyone Should Know About?</a></Link>
                    ...
                    <div className="style-1-img color-bg-5">
                        <Link href="#"><a><Image width={110} height={110} src="/assets/imgs/page/shop1/img-5.png" alt="Agon" /></a></Link>
                    </div>
                    </div>
                    <div className="card-list-style-1">
                    <Link href="#"><a className="text-heading-6">Design Studios That Everyone Should Know About?</a></Link>
                    ...
                    <div className="style-1-img color-bg-9">
                        <Link href="#"><a><Image width={110} height={110} src="/assets/imgs/page/shop1/img-6.png" alt="Agon" /></a></Link>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div className="container">
                ...
                <div className="mt-60">
                    ...
                    <Link href="#"><a><Image width={150} height={45} src="/assets/imgs/page/homepage5/google-play.svg" alt="agon" /></a></Link>
                </div>
