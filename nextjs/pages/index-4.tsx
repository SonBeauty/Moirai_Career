                    ...
                    <div className="container mt-90">
                        <div className="row">
                            <div className="col-lg-6 col-sm-12 block-img-we-do">
                                <div className="inner-image"><Image width={618} height={716} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage2/img-2.png" alt="Agon" /></div>
                            </div>
                            <div className="col-lg-6 col-sm-12 block-we-do-2"><span className="tag-1 color-orange-900">What We Do, What You Get</span>
                                ...
                                <div className="list-icons mt-50">
                                    <div className="item-icon none-bd hover-up"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/homepage2/icon-work.svg" alt="Agon" /></span>
                                    ...
                                    <div className="item-icon none-bd hover-up"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/homepage2/icon-design.svg" alt="Agon" /></span>
                                        <h4 className="text-heading-4">Designed for teams of all sorts and sizes</h4>
                                        <p className="text-body-excerpt color-gray-600 mt-15">Aliquam a augue suscipit, luctus neque purus ipsum neque at dolor primis libero tempus, blandit</p>
                                    </div>
                                    <div className="item-icon none-bd hover-up"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/homepage2/icon-advance.svg" alt="Agon" /></span>
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-sm-12">
                                <div className="bg-2 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    ...
                                    <div className="box-image-inner bg-color-1"><Image width={498} height={389} src="/assets/imgs/page/homepage2/temp-1.png" alt="Agon" /></div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-sm-12">
                                <div className="bg-6 box-square hover-up wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                    ...
                                    <p className="text-body-text-md color-gray-600">Your site is not complete with only landings. Get essential inner pages using our ready demos.</p>
                                    <div className="box-image-inner bg-color-2"><Image width={498} height={389} src="/assets/imgs/page/homepage2/temp-2.png" alt="Agon" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
