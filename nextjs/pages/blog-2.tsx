                                ...
                                <div className="col-lg-4 col-sm-6 pr-30 mb-50">
                                    <div className="card-grid-style-4">
                                        <div className="grid-4-img mb-20">
                                            <Link href="/blog-single"><a><Image width={398} height={465} src="/assets/imgs/page/blog/2/img-1.png" alt="Agon" />
                                            </a></Link>
                                        </div>
                                ...
                                <div className="col-lg-4 col-sm-6 pr-30 mb-50">
                                    <div className="card-grid-style-4">
                                        <div className="grid-4-img color-bg-2 mb-20">
                                            <Link href="/blog-single"><a><Image width={398} height={465} src="/assets/imgs/page/blog/2/img-2.png" alt="Agon" />
                                            </a></Link>
                                        </div>
                                        <Link href="/blog-single"><a className="text-heading-4">We can blend colors multiple ways, the most common
                                        </a></Link>
                                ...
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-list-style-1">
                                        ...
                                        <div className="style-1-img color-bg-10">
                                            <Link href="/blog-single"><a><Image width={110} height={110} src="/assets/imgs/page/blog/2/img-news-1.png" alt="Agon" />
                                            </a></Link>
                                        </div>
                                    </div>
                                    <div className="card-list-style-1">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Company</span>
                                        ...
                                        <div className="grid-4-img color-bg-2">
                                            <Link href="/blog-single"><a><Image width={398} height={255} src="/assets/imgs/page/homepage1/img-news-4.png" alt="Agon" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Marketing Event</span>
                                        ...
                                        <div className="grid-4-img color-bg-8">
                                            <Link href="/blog-single"><a><Image width={398} height={255} src="/assets/imgs/page/homepage1/img-news-5.png" alt="Agon" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Customer Services</span>
                                        ...
                                        <div className="grid-4-img color-bg-1">
                                            <Link href="/blog-single"><a><Image width={398} height={255} src="/assets/imgs/page/homepage1/img-news-6.png" alt="Agon" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Company</span>
                                        ...
                                        <div className="grid-4-img color-bg-2">
                                            <Link href="/blog-single"><a><Image width={398} height={255} src="/assets/imgs/page/homepage1/img-news-7.png" alt="Agon" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Marketing Event</span>
                                        ...
                                        <div className="grid-4-img color-bg-8">
                                            <Link href="/blog-single"><a><Image width={398} height={255} src="/assets/imgs/page/homepage1/img-news-8.png" alt="Agon" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Customer Services</span>
                                        ...
                                        <div className="grid-4-img color-bg-1">
                                            <Link href="/blog-single"><a><Image width={398} height={255} src="/assets/imgs/page/homepage1/img-news-9.png" alt="Agon" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
