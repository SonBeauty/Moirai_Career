    ...
    <Layout>
        ...
        <div className="container mt-70">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                ...
                <Link href="#"><a>
                <div className="product-image"><Image width={365} height={246} src="/assets/imgs/page/homepage8/img-3.png" alt="image" /></div>
                </a></Link>
                <div className="product-info">
                    <div className="rating">
                    <div className="box-rating">
                        <span><Image width={12} height={12} alt="image" src="/assets/imgs/page/homepage5/star-active.svg" /></span>
                        <span><Image width={12} height={12} alt="image" src="/assets/imgs/page/homepage5/star-active.svg" /></span>
                        <span><Image width={12} height={12} alt="image" src="/assets/imgs/page/homepage5/star-active.svg" /></span>
                        <span><Image width={12} height={12} alt="image" src="/assets/imgs/page/homepage5/star-active.svg" /></span>
                        <span><Image width={12} height={12} alt="image" src="/assets/imgs/page/homepage5/star.svg" /></span>
                    </div>
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                ...
                <Link href="#"><a>
                <div className="product-image"><Image width={365} height={246} src="/assets/imgs/page/homepage8/img-4.png" alt="image"/></div>
                </a></Link>
                <div className="product-info">
                    <div className="rating">
                    <div className="box-rating">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                ...
                <Link href="#"><a>
                <div className="product-image"><Image width={365} height={246} src="/assets/imgs/page/homepage8/img-5.png" alt="image"/></div>
                </a></Link>
                <div className="product-info">
                    <div className="rating">
                    <div className="box-rating">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div className="product-item-2 product-item-3 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                <Link href="#"><a>
                <div className="product-image"><Image width={365} height={246} src="/assets/imgs/page/homepage8/img-6.png" alt="image"/></div>
                </a></Link>
                <div className="product-info">
                    <div className="rating">
                    <div className="box-rating">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div className="product-item-2 product-item-3 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                <Link href="#"><a>
                <div className="product-image"><Image width={365} height={246} src="/assets/imgs/page/homepage8/img-7.png" alt="image"/></div>
                </a></Link>
                <div className="product-info">
                    <div className="rating">
                    <div className="box-rating">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div className="product-item-2 product-item-3 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                <Link href="#"><a>
                <div className="product-image"><Image width={365} height={246} src="/assets/imgs/page/homepage8/img-8.png" alt="image"/></div>
                </a></Link>
                <div className="product-info">
                    <div className="rating">
                    <div className="box-rating">
