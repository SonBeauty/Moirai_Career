        ...
        <Layout>
            ...
            <div className="container mt-120">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12 block-img-we-do text-center"><Image width={494} height={605} className="img-small img-responsive" src="/assets/imgs/page/homepage7/img-1.png" alt="Agon" />
                    <div className="block-card"><Image width={250} height={190} src="/assets/imgs/page/homepage5/card.png" alt="Agon" /></div>
            ...
            <div className="container mt-90">
                ...
                <div className="col-lg-4 col-sm-6 pr-30 mb-50">
                    ...
                    <div className="grid-4-img mb-20">
                        <Link href="#"><a><Image width={396} height={465} src="/assets/imgs/page/blog/2/img-1.png" alt="Agon" /></a></Link>
                    </div>
                ...
                <div className="col-lg-4 col-sm-6 pr-30 mb-50">
                    ...
                    <div className="grid-4-img color-bg-2 mb-20">
                        <Link href="#"><a><Image width={396} height={465} src="/assets/imgs/page/blog/2/img-2.png" alt="Agon" /></a></Link>
                    </div>
                    <Link href="#"><a className="text-heading-4">We can blend colors multiple ways, the most common</a></Link>
                    <p className="text-body-text color-gray-500">Lorem ipsum dolor sit amet consectetur adipiscing elit interdum ullamcorper sed pharetra senectus donec nunc. Consequat semper viverra nam libero justo laoreet facilisis magna etiam.</p>
                    <div className="blog-img-user">
                ...
                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                    ...
                    <div className="style-1-img color-bg-10">
                        <Link href="#"><a><Image width={110} height={110} src="/assets/imgs/page/blog/2/img-news-1.png" alt="Agon" /></a></Link>
                    </div>
                    </div>
                    <div className="card-list-style-1">
                        <Link href="#"><a className="text-heading-6">Design Studios That Everyone Should Know About?</a></Link>
            ...
            <div className="container mt-100">
                ...
                <div className="col-lg-10">
                    ...
                    <div className="row">
                        ...
                        <div className="block-chart"><Image width={255} height={193} src="/assets/imgs/template/chart.png" alt="Agon" /></div>
                        <Image width={332} height={404} className="img-responsive img-newsletter" src="/assets/imgs/page/homepage2/img-newsletter.png" alt="Agon" />
                        </div>
                    </div>
                    </div>
                </div>
