...
function ShopGrid2(): JSX.Element {
return (
    <>
    <Layout>
            ...
            <div className="sidebar">
                ...
                <ul className="list-products-sidebar">
                    ...
                    <div className="product-item-2 product-item-4">
                        <div className="product-image">
                        <Link href="#"><a><Image width={65} height={67} src="/assets/imgs/page/shop1/sp5.png" alt="agon" /></a></Link></div>
                    ...
                    <div className="product-item-2 product-item-4">
                        <div className="product-image">
                        <Link href="#"><a><Image width={65} height={67} src="/assets/imgs/page/homepage5/sp1.png" alt="agon" /></a></Link></div>
                        <div className="product-info">
                        <Link href="#"><a>
                    ...
                    <div className="product-item-2 product-item-4">
                        <div className="product-image">
                        <Link href="#"><a><Image width={65} height={67} src="/assets/imgs/page/homepage5/sp2.png" alt="agon" /></a></Link></div>
                        <div className="product-info">
                        <Link href="#"><a>
                            <h3 className="text-heading-7 color-gray-900">All Natural Italian-Style Chicken Meatballs</h3>
                        </a></Link>
                    ...
                    <div className="product-item-2 product-item-4">
                        <div className="product-image">
                        <Link href="#"><a><Image width={65} height={67} src="/assets/imgs/page/homepage5/sp3.png" alt="agon" /></a></Link></div>
                        <div className="product-info">
                        <Link href="#"><a>
                            <h3 className="text-heading-7 color-gray-900">All Natural Italian-Style Chicken Meatballs</h3>
                        </a></Link>
                    ...
                    <div className="product-item-2 product-item-4">
                        <div className="product-image">
                        <Link href="#"><a><Image width={65} height={67} src="/assets/imgs/page/shop1/sp4.png" alt="agon" /></a></Link></div>
                        <div className="product-info">
                        <Link href="#"><a>
                            <h3 className="text-heading-7 color-gray-900">All Natural Italian-Style Chicken Meatballs</h3>
                        </a></Link>
        ...
        <div className="container mt-70">
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                ...
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/pc.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/headphone.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/laptop.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/mobile.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/printer.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/book.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/tablet.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/usb.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/mouse.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/security.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/watch.svg" alt="agon" /></a></Link></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="category-grid-3 hover-up">
                <div className="category-img">
                    <Link href="#"><a><Image width={81} height={81} src="/assets/imgs/page/shop1/scan.svg" alt="agon" /></a></Link></div>
