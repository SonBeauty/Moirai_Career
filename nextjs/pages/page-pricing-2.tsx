...
function Pricing2(): JSX.Element {
    return (
        <>
            <Layout headerStyle={"header-style-6 normal-logo"}>
                <section className="section-box">
                    <div className="bg-pricing-2">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 col-sm-10 col-12 text-center mt-40">
                                <h2 className="text-heading-1 color-gray-900 mb-10">Customer Lifecycle</h2>
                                <p className="text-body-lead-large color-gray-600 mt-20">We understand that the relationship with our customers extends beyond a single transaction, which is why we focus on nurturing and supporting them throughout the entire customer lifecycle.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-12 col-sm-12">
                                <div className="list-icons mt-50">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/homepage2/icon-acquis.svg" alt="Moirai" /></span>
                            ...
                            <div className="col-lg-4 col-md-12 col-sm-12">
                                <div className="list-icons mt-50">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/homepage2/icon-active.svg" alt="Moirai" /></span>
                            ...
                            <div className="col-lg-4 col-md-12 col-sm-12">
                                <div className="list-icons mt-50">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/homepage2/icon-retent.svg" alt="Moirai" /></span>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-8 col-sm-10 col-12 text-center mt-40">
                                <h2 className="text-heading-1 color-gray-900 mb-10">Application Flatform</h2>
                                <p className="text-body-lead-large color-gray-600 mt-20">An application platform is a software framework or infrastructure that provides a foundation for developing and running applications. It typically includes tools, libraries, and services that simplify the development process, enable application deployment, and facilitate scalability and performance optimization. </p>
                            </div>
                            <div className="col-lg-2 col-sm-1 col-12" />
                        </div>
                    </div>
