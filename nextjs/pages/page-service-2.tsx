                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-8">
                                            <div className="banner-imgs">
                                                <div className="block-1 shape-2"><Image width={212} height={216} className="rounded-3" src="/assets/imgs/page/services/2/banner2.png" alt="Agon" /></div>
                                                <div className="block-2 shape-2"><Image width={310} height={96} className="rounded-3" src="/assets/imgs/page/services/2/banner1.png" alt="Agon" /></div>
                                                <div className="block-3 shape-2"><Image width={400} height={203} className="rounded-3" src="/assets/imgs/page/services/2/banner3.png" alt="Agon" /></div>
                                                <Image width={856} height={587} src="/assets/imgs/page/services/1/banner.png" alt="Agon" />
                                            </div>
                                        </div>
                                        <div className="col-lg-2" />
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <ul className="list-partners">
                                    <li>
                                        <Link href="/#"><a className="item-logo box-hover-shadow"><Image width={203} height={52} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-1.svg" /></a></Link>
                                    </li>
                                    <li>
                                        <Link href="/#"><a className="item-logo box-hover-shadow"><Image width={203} height={52} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-1.svg" /></a></Link>
                                    </li>
                                    <li>
                                        <Link href="/#"><a className="item-logo box-hover-shadow"><Image width={203} height={52} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-2.svg" /></a></Link>
                                    </li>
                                    <li>
                                        <Link href="/#"><a className="item-logo box-hover-shadow"><Image width={203} height={52} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-3.svg" /></a></Link>
                                    </li>
                                    <li>
                                        <Link href="/#"><a className="item-logo box-hover-shadow"><Image width={203} height={52} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-4.svg" /></a></Link>
                                    </li>
                                    <li>
                                        <Link href="/#"><a className="item-logo box-hover-shadow"><Image width={203} height={52} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-5.svg" /></a></Link>
                                    </li>
                                    <li>
                                        <Link href="/#"><a className="item-logo box-hover-shadow"><Image width={203} height={52} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-6.svg" /></a></Link>
                                    </li>
                                    <li>
                                        <Link href="/#"><a className="item-logo box-hover-shadow"><Image width={203} height={52} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-7.svg" /></a></Link>
                                    </li>
                                    <li>
                                        <Link href="/#"><a className="item-logo box-hover-shadow"><Image width={203} height={52} alt="Agon" src="/assets/imgs/slider/logo/sample-logo-8.svg" /></a></Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-sm-12">
                                <div className="bg-2 box-square hover-up">
                                    ...
                                    <div className="box-image-inner bg-color-1"><Image width={498} height={390} src="/assets/imgs/page/homepage2/temp-1.png" alt="Agon" /></div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-sm-12">
                                <div className="bg-6 box-square hover-up">
                                    ...
                                    <p className="text-body-text-md color-gray-600">Your site is not complete with only landings. Get essential inner pages using our ready demos.</p>
                                    <div className="box-image-inner bg-color-2"><Image width={498} height={390} src="/assets/imgs/page/homepage2/temp-2.png" alt="Agon" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
