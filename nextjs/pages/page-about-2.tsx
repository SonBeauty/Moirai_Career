                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 d-none d-lg-block">
                                    <div className="banner-imgs">
                                        <div className="block-1 shape-2"><Image width={350} height={500} src="/assets/imgs/page/about/2/banner.png" alt="Agon" /></div>
                                        <div className="float-end col-lg-6 mt-90">
                                            <div className="list-icons mt-50">
                                                ...
                                                <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/about/2/icon-constant.svg" alt="Agon" /></span>
                                ...
                                <ul className="list-steps">
                                    <li className="icon-asset1 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                        <div className="text-center block-step">
                                            <div className="mb-30"><Image width={80} height={80} src="/assets/imgs/page/about/2/icon-start-plan.svg" alt="Agon" /></div>
                                    ...
                                    <li className="icon-asset2 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                        <div className="text-center block-step">
                                            <div className="mb-30"><Image width={80} height={80} src="/assets/imgs/page/about/2/icon-connect.svg" alt="Agon" /></div>
                                    ...
                                    <li className="icon-asset3 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                        <div className="text-center block-step bg-5">
                                            <div className="mb-30"><Image width={80} height={80} src="/assets/imgs/page/about/2/icon-match.svg" alt="Agon" /></div>
                                    ...
                                    <li className="icon-asset4 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
                                        <div className="text-center block-step bg-5">
                                            <div className="mb-30"><Image width={80} height={80} src="/assets/imgs/page/about/2/icon-complete.svg" alt="Agon" /></div>
                                    ...
                                    <li className="wow animate__animated animate__fadeIn" data-wow-delay=".7s">
                                        <div className="text-center block-step bg-9">
                                            <div className="mb-30"><Image width={80} height={80} src="/assets/imgs/page/about/2/icon-review.svg" alt="Agon" /></div>
                    ...
                    <div className="container">
                        <div className="row">       
                            <div className="col-lg-6 col-sm-12 col-12 block-gallery-1">
                                <div className="row">
                                    <div className="col-lg-6 block-gallery-col">
                                        <Image width={306} height={204} className="img-responsive" src="/assets/imgs/page/about/2/img-2.png" alt="Agon" />
                                        <Image width={306} height={204} className="img-responsive" src="/assets/imgs/page/about/2/img-3.png" alt="Agon" />
                                    </div>
                                    <div className="col-lg-6"><Image width={306} height={428} className="img-responsive" src="/assets/imgs/page/about/2/img-1.png" alt="Agon" /></div>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-sm-12 pr-30">
                                <div className="card-grid-style-4"><span className="tag-dot">Company</span>
                                    <Link href="/blog-single"><a className="text-heading-4">We can blend colors multiple ways, the most common</a></Link>
                                    <div className="grid-4-img">
                                        <Link href="/blog-single"><a><Image width={398} height={255} src="/assets/imgs/page/homepage1/img-news-4.png" alt="Agon" /></a></Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 col-sm-12 pr-30">
                                <div className="card-grid-style-4"><span className="tag-dot">Marketing Event</span>
                                    <Link href="/blog-single"><a className="text-heading-4">How To Blow Through Capital At An Incredible Rate</a></Link>
                                    <div className="grid-4-img">
                                        <Link href="/blog-single"><a><Image width={398} height={255} src="/assets/imgs/page/homepage1/img-news-5.png" alt="Agon" /></a></Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 col-sm-12 pr-30">
                                <div className="card-grid-style-4"><span className="tag-dot">Customer Services</span>
                                    <Link href="/blog-single"><a className="text-heading-4">Design Studios That Everyone Should Know About?</a></Link>
                                    <div className="grid-4-img color-bg-4">
                                        <Link href="/blog-single"><a><Image width={398} height={255} src="/assets/imgs/page/homepage1/img-news-6.png" alt="Agon" /></a></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
