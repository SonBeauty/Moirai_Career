            ...
            <Layout>
                ...
                <section className="section-box">
                    <div className="container mt-120">
                        <div className="row">
                            <div className="col-lg-6 col-sm-12 block-img-we-do"><Image width={618} height={716} className="bdrd-16 img-responsive" src="/assets/imgs/page/homepage3/img-2.png" alt="Agon" /></div>
