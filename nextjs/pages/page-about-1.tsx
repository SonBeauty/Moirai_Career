                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-5 d-none d-lg-block">
                                    <div className="banner-imgs">
                                        <div className="block-1 shape-1"><Image width={220} height={296} src="/assets/imgs/page/about/1/banner2.png" alt="Agon" /></div>
                                        <div className="img-responsive shape-2"><Image width={510} height={686}  alt="Agon" src="/assets/imgs/page/about/1/banner1.png" /></div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-10">
                                <div className="box-image">
                                    ...
                                    <Image width={1076} height={520} className="img-responsive bdrd-16" src="/assets/imgs/page/about/1/img-1.png" alt="Agon" />
                                </div>
                            </div>
                            <div className="col-lg-1" />
                        </div>
