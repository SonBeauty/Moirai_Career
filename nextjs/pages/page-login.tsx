                                ...
                                <div className="col-xxl-5 col-xl-6 col-lg-6 col-md-12 login-right pr-0">
                                    <div className="box-login-form">
                                        <div className="box-signup mt-90">
                                            ...
                                            <Link href="/#"><a className="btn btn-login-google color-gray-500 text-heading-6 box-shadow-2"><Image width={20} height={20} className="img-responsive img-middle" src="/assets/imgs/template/icons/Icon-gg-login.svg" alt="Agon" /> Sign in with Google</a></Link>
