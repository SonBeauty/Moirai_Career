            ...
            <Layout>
                ...
                <div className="banner-hero banner-homepage5">
                    ...
                    <div className="row">
                        ...
                        <div className="banner-imgs">
                            <div className="block-1 shape-2"><Image width={84} height={88} src="/assets/imgs/page/homepage5/circle-1.svg" alt="Agon" /></div>
                            <div className="block-2 shape-3"><Image width={55} height={58} src="/assets/imgs/page/homepage5/circle-2.svg" alt="Agon" /></div>
                            ...
                            <div className="img-responsive shape-1">
                                <Image width={416} height={416} alt="Agon" src="assets/imgs/page/homepage5/banner.png" />
                            </div>
                        </div>
                        </div>
                    </div>
                ...
                <div className="container mt-120 mb-60">
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                        ...
                        <Link href="#"><a>
                        <div className="product-image"><Image width={121} height={150} src="/assets/imgs/page/homepage5/sp1.png" alt="image"/></div>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                        ...
                        <Link href="#"><a>
                        <div className="product-image"><Image width={121} height={150} src="/assets/imgs/page/homepage5/sp2.png" alt="image"/></div>
                        <div className="product-info">
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                        ...
                        <Link href="#"><a>
                        <div className="product-image"><Image width={121} height={150} src="/assets/imgs/page/homepage5/sp3.png" alt="image"/></div>
                        <div className="product-info">
                ...
                <div className="container">
                    ...
                    <div className="col-lg-12">
                        ...
                        <li>
                            <Link href="#"><a className="item-logo box-hover-shadow hover-up"><Image width={203} height={52} alt="Agon" src="assets/imgs/page/homepage5/agon.svg" /></a></Link>
                            </li>
                        <li>
                            <Link href="#"><a className="item-logo box-hover-shadow hover-up"><Image width={203} height={52} alt="Agon" src="assets/imgs/page/homepage5/monst.svg" /></a></Link>
                            </li>
                        <li>
                            <Link href="#"><a className="item-logo box-hover-shadow hover-up"><Image width={203} height={52} alt="Agon" src="assets/imgs/page/homepage5/figwire.svg" /></a></Link>
                            </li>
                        <li>
                            <Link href="#"><a className="item-logo box-hover-shadow hover-up"><Image width={203} height={52} alt="Agon" src="assets/imgs/page/homepage5/evara.svg" /></a></Link>
                            </li>
                        <li>
                            <Link href="#"><a className="item-logo box-hover-shadow hover-up"><Image width={203} height={52} alt="Agon" src="assets/imgs/page/homepage5/frox.svg" /></a></Link>
                            </li>
                        <li>
                            <Link href="#"><a className="item-logo box-hover-shadow hover-up"><Image width={203} height={52} alt="Agon" src="assets/imgs/page/homepage5/alithemes.svg" /></a></Link>
                            </li>
                        <li>
                            <Link href="#"><a className="item-logo box-hover-shadow hover-up"><Image width={203} height={52} alt="Agon" src="assets/imgs/page/homepage5/nestmask.svg" /></a></Link>
                            </li>
                        <li>
                            <Link href="#"><a className="item-logo box-hover-shadow hover-up"><Image width={203} height={52} alt="Agon" src="assets/imgs/page/homepage5/theflow.svg" /></a></Link>
                            </li>
                        <li>
                            <Link href="#"><a className="item-logo box-hover-shadow hover-up"><Image width={203} height={52} alt="Agon" src="assets/imgs/page/homepage5/stacker.svg" /></a></Link>
                            </li>
                        </ul>
                    </div>
                    </div>
