            ...
            <Layout>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-10">
                                <div className="box-image">
                                    ...
                                    <Image width={1076} height={505} className="img-responsive bdrd-16" src="/assets/imgs/page/about/3/img.png" alt="Agon" /></div>
                            </div>
                            <div className="col-lg-1" />
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-12 col-sm-12">
                                <div className="list-icons mt-50">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/homepage2/icon-acquis.svg" alt="Agon" /></span>
                            ...
                            <div className="col-lg-4 col-md-12 col-sm-12">
                                <div className="list-icons mt-50">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/homepage2/icon-active.svg" alt="Agon" /></span>
                            ...
                            <div className="col-lg-4 col-md-12 col-sm-12">
                                <div className="list-icons mt-50">
                                    <div className="item-icon none-bd"><span className="icon-left"><Image width={64} height={64} src="/assets/imgs/page/homepage2/icon-retent.svg" alt="Agon" /></span>
                ...
                <section className="section-box">
                    <div className="container mt-120">
                        <div className="row">
                            <div className="col-lg-6 col-sm-12 block-img-we-do"><Image width={618} height={728} className="bdrd-16 img-responsive" src="/assets/imgs/page/about/3/img-2.png" alt="Agon" /></div>
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-sm-12">
                                <div className="bg-2 box-square hover-up">
                                    ...
                                    <div className="box-image-inner bg-color-1"><Image width={398} height={290} src="/assets/imgs/page/homepage2/temp-1.png" alt="Agon" /></div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-sm-12">
                                <div className="bg-6 box-square hover-up">
                                    ...
                                    <p className="text-body-text-md color-gray-600">Your site is not complete with only landings. Get essential inner pages using our ready demos.</p>
                                    <div className="box-image-inner bg-color-2"><Image width={398} height={290} src="/assets/imgs/page/homepage2/temp-2.png" alt="Agon" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
